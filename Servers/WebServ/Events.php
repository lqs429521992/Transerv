...
class Events
{
    ...
    public static function getConnection(){
        ...
        self::$mysql_conn=new MysqlConnection('127.0.0.1',
            ...
            'transerv',
            'transerv');
        echo "[".date("Y/m/d H:i:s")."]    『WsServ』 已建立数据库连接!\n";
        return self::$mysql_conn;
    }
    ...
    public static function onMessage($client_id, $message){
        ...
        if ($msgarr['obj']['prot']=='tcp') {
            try {
                $ws_conn = new AsyncTcpConnection('tcp://127.0.0.1:8282');
                $ws_conn->connect();
    ...
    public static function onClose($client_id){
        $sql="DELETE from tb_ws WHERE net_id ='".$client_id."' ";
        self::getConnection()->query($sql);
        echo $client_id."已退出\n";
    }
}